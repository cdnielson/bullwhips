...
@Component(selector: 'in-stock-page', templateUrl: 'in_stock_page.html')
class InStockPage {
  ...
  InStockPage(ProductsService this.productsService, Cart this.cart, Router this._router, MenuService this.menu);
